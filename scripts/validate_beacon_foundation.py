...
required = {
    ...
    "internal/gcdns/dnssec_answer.go": ("func (v *DNSSECValidator) AuthenticateTerminalAnswer", "AuthenticateNSECNODATA", "AuthenticateNSECNXDOMAIN", "terminal DNSSEC validation requires authenticated DNSKEYs", "v.ValidateRRSet", "return DNSSECSecure, nil"),
...
print("GoreeCloud Beacon cache, scheduler, transport, iterative resolver, DNSSEC trust carry, terminal validation, NSEC NODATA/NXDOMAIN denial, and competitive-superset source contract: PASS")
