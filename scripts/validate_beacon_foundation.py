...
required = {
    ...
    "internal/gcdns/dnssec_chain.go": ("func (v *DNSSECValidator) TrustedKeysForDS", "func (v *DNSSECValidator) AuthenticateDNSKEYResponse", "func (v *DNSSECValidator) AuthenticateDelegationDS", "AuthenticateInsecureDelegationNSEC", "DNSKEY RRset", "missing RRSIG", "DNSSECIndeterminate"),
    ...
    "internal/gcdns/dnssec_nsec.go": ("func (v *DNSSECValidator) AuthenticateInsecureDelegationNSEC", "func (v *DNSSECValidator) AuthenticateNSECNODATA", "nsecHasType", "DNSSECInsecure", "DNSSECIndeterminate"),
    "internal/gcdns/dnssec_nsec_test.go": ("TestNSECHasType", "TestAuthenticateInsecureDelegationNSECMissingProofIsIndeterminate", "TestAuthenticateInsecureDelegationNSECRejectsUnsignedProof", "TestAuthenticateInsecureDelegationNSECRejectsDSBitmap", "TestAuthenticateNSECNODATARequiresExactSignedProof"),
    "internal/gcdns/dnssec_answer.go": ("func (v *DNSSECValidator) AuthenticateTerminalAnswer", "AuthenticateNSECNODATA", "terminal DNSSEC validation requires authenticated DNSKEYs", "v.ValidateRRSet", "return DNSSECSecure, nil"),
    "internal/gcdns/dnssec_answer_test.go": ("TestAuthenticateTerminalAnswerNegativeRemainsIndeterminate", "TestAuthenticateTerminalAnswerEmptyNoErrorWithoutProofIsIndeterminate", "TestAuthenticateTerminalAnswerRequiresKeys", "TestAuthenticateTerminalAnswerUnsignedPositiveIsBogus", "TestAuthenticateTerminalAnswerNilResponseIsBogus"),
...
print("GoreeCloud Beacon cache, scheduler, transport, iterative resolver, DNSSEC trust carry, terminal validation, NSEC denial foundation, and competitive-superset source contract: PASS")
