...
required = {
    ...
    "internal/gcdns/scheduler.go": ("type ResolverTarget struct", "type TargetScheduler struct", "AttemptTimeout time.Duration", "MaxConcurrent  int", "context.WithTimeout", "func (s *TargetScheduler) orderedTargets", "func (s *TargetScheduler) Stats", "(*TargetScheduler)(nil)"),
    ...
    "internal/gcdns/iterative.go": ("type DNSExchanger interface", "type IterativeResolver struct", "RecursionDesired = false", "requestDNSSECMaterial", "referralTargets", "buildReferralPlan", "delegation loop detected", "responseCacheTTL", "(*IterativeResolver)(nil)"),
    ...
    "internal/gcdns/iterative_dnssec.go": ("type DNSSECChainAuthenticator interface", "type DNSSECTerminalAuthenticator interface", "type ValidatingIterativeResolver struct", "chainSecure := true", "case DNSSECInsecure", "lacks authenticated DS or denial proof", "AuthenticateTerminalAnswer", "(*ValidatingIterativeResolver)(nil)"),
